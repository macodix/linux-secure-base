...
```sh
curl -LO https://github.com/macodix/linux-secure-base/releases/download/installer-v0.1.0-rc3/lsb-installer-0.1.0.tar.gz
curl -LO https://github.com/macodix/linux-secure-base/releases/download/installer-v0.1.0-rc3/lsb-installer-0.1.0.tar.gz.asc
