...
|---------|-------|-----|----------|
| 0.01 | 2026-06-26 | Claude | Erstanlage: Klassen-, Komponenten-/Datenfluss-, Sequenz- und Zustandsdiagramm in Mermaid, abgeleitet aus `docs/pifos/konzept.md` und `docs/pifos/anforderungen.md`. |
</content>
